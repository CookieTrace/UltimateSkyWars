...
public class FormWindowUSW extends FormWindow {
    ...
    public FormWindowUSW(String related,String title) {
        this(title, new ArrayList<>());
        this.related = related;
    }

    public FormWindowUSW(String title, List<Element> contents) {
        this(title, contents, (ElementButtonImageData) null);
    }

    public FormWindowUSW(String title, List<Element> contents, String icon) {
        this(title, contents, icon.isEmpty() ? null : new ElementButtonImageData(ElementButtonImageData.IMAGE_DATA_TYPE_URL, icon));
    }

    public FormWindowUSW(String title, List<Element> contents, ElementButtonImageData icon) {
        this.title = title;
